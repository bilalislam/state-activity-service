...
import com.turknet.stateactivityservice.exception.ResourceNotFoundException;
import java.net.URI;
...
public class GlobalExceptionHandler {
    ...
    ProblemDetail onException(Exception exception) {
        if (exception instanceof ResourceNotFoundException resourceNotFoundException) {
            ...
            problemDetail.setType(URI.create("http://api.state-activity-service.com/errors/not-found"));
